...
def test_tajectory_helper(v, d, rho, angle, z):
    '''
    ...
    for i in range(-100, 201, 10):
        d_sim = tra.trajectory(v_ms, i, rho, a_r, axis, step, z=z_m)
        ds_sim[d_sim] = [i]
...
def test_trajectory(name_first, name_last, rho, team, year, hit_type):
    '''
